package com.horidream.display
{
	...
	public class DistortImage extends Sprite
	{
		...
		public function DistortImage(target:DisplayObject,hseg:uint=2,vseg:uint=2):void 
		{
			if(target.parent){
			...
			_vseg = vseg;
			_hseg = hseg;
			sourceBitmapData = new BitmapData(_w,_h,true,0x00FFFFFF);
			sourceBitmapData.draw(target);
			tl = sourceBitmapData.rect.topLeft;
			br = sourceBitmapData.rect.bottomRight;
		 ...
		 * 
		 */
		public function setTransform   (tl:Point, 
										tr:Point, 
										br:Point, 
										bl:Point):void {
			this.tl = tl;
			...
			__render(this.graphics, sourceBitmapData);
		}
