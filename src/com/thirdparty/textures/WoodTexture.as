package  com.thirdparty.textures {
	...
	public class WoodTexture extends Sprite {
		...
		function WoodTexture(target:DisplayObject):void {
			...
			var boundsRect:Rectangle = source.getBounds(source);
			...
			sourceBitmapData.draw(source,new Matrix(1,0,0,1,-boundsRect.x,-boundsRect.y),null,null,null,true);
